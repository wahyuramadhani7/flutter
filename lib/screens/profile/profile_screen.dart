...
class _ProfileScreenState extends State<ProfileScreen> {
 ...
 Future<void> _fetchUserData() async {
   try {
     final response = await http.get(Uri.parse('https://676f7adfb353db80c322d0f3.mockapi.io/users'));
 ...
 Widget build(BuildContext context) {
   return Scaffold(
     ...
     appBar: AppBar(
       ...
       title: Text('@${widget.username}', style: const TextStyle(color: Colors.white, fontSize: 16)),
       centerTitle: true,
       actions: [
         if (isEditing)
           TextButton(
                 ...
                 children: [
                   ...
                   Row(
                     ...
                     children: [
                       ...
                       if (isEditing)
                         TextButton(
                           onPressed: _updateUserData,
                           child: const Text('Save & Update', style: TextStyle(color: Colors.white, fontSize: 16)),
                         ),
                     ],
                   ),
                       ...
                       child: ElevatedButton(
                         ...
                         child: Row(
                           ...
                           children: const [
                             ...
                             SizedBox(width: 8),
                             Text('Add image', style: TextStyle(color: Colors.white, fontSize: 16)),
                           ],
                         ),
                       ),
                     ),
                   if (!isEditing && userData?['about'] != null)
                     Padding(
                       ...
                       child: Text(userData!['about']!, style: const TextStyle(color: Colors.white, fontSize: 16)),
                     ),
                   if (isEditing) ...[
                     _buildTextField(
                   ...
                   const SizedBox(height: 24),
                   const Text('Interest', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
                   const SizedBox(height: 16),
                   if (isEditing)
                     _buildTextField(
